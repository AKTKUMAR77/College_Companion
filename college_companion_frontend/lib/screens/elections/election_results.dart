              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(winner['name'], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 24, color: Colors.black87)),
                    Text('With ${(((_results[winner['id']] ?? 0) / _totalVotes) * 100).toStringAsFixed(1)}% of the votes', style: const TextStyle(color: Colors.black54)),
                  ],
                ),
              ),
